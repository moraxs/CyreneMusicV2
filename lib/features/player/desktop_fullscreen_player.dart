              ...
              Positioned(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Expanded(child: _MainCapsule(playback: widget.playback)),
                    const SizedBox(width: 16),
...
class _ClassicRecordStage extends StatefulWidget {
  const _ClassicRecordStage({
    required this.track,
    required this.size,
  ...
  @override
  State<_ClassicRecordStage> createState() => _ClassicRecordStageState();
}

class _ClassicRecordStageState extends State<_ClassicRecordStage>
  ...
  @override
  void didUpdateWidget(covariant _ClassicRecordStage oldWidget) {
...
class _MainCapsule extends StatelessWidget {
  const _MainCapsule({required this.playback});
